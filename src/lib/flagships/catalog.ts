...
const VISUAL_SIGNATURES: Record<FlagshipId, FlagshipVisualSignature> = {
  ...
  "mercedes-epoque": {
    shell: "museum-hire-salon",
    typography: "cream-display-serif-and-tracked-caps",
    navigation: "era-pills-and-reservation-folio",
    geometry: "full-bleed-gullwing-and-fleet-plates",
    density: "airy",
    palette: ["#070707", "#f3ebda", "#8f1d2c"],
  ...
  italvia: {
    ...
    geometry: "italian-road-plates-and-season-twin",
    density: "balanced",
    palette: ["#1a2744", "#f4efe6", "#c45c3e"],
    motion: "season-reveal",
  },
  "mini4wd-lab": {
    shell: "neon-workshop-bench",
    typography: "condensed-pit-sans",
    navigation: "build-carbon-track-tabs",
    geometry: "track-photo-and-chassis-plates",
    density: "dense",
    palette: ["#07080a", "#3dffd0", "#ff3b5c"],
    motion: "jump-launch",
  },
  "atelier-nova": {
