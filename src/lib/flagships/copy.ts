...
export const FLAGSHIP_IDS = ["orbit-command", "neura", "synapse", "vanta", "arc-city", "morph", "studio-ledger", "pulse-booking", "foundry-erp", "atelier-nova", "casa-verde", "lumen-clinic", "northstar-legal", "velora-commerce", "festival-onda"] as const;
...
const LABELS: Record<Locale, ShowcaseLabels> = {
  en: {
    ...
    sitesTitle: "Websites by sector",
    sitesLead: "Six complete digital experiences for professional services, hospitality, health, commerce and culture.",
    projectsCount: "15 live projects",
    archiveTitle: "More examples",
    archiveLead: "Earlier experiments remain available as an archive; they are separate from the fifteen flagship projects.",
  ...
  it: {
    ...
    sitesTitle: "Siti divisi per settore",
    sitesLead: "Sei esperienze complete per professionisti, ospitalità, salute, commercio e cultura.",
    projectsCount: "15 progetti live",
    archiveTitle: "Altri esempi",
    archiveLead: "Gli esperimenti precedenti restano disponibili in archivio, separati dai quindici progetti principali.",
  ...
  es: {
    ...
    sitesTitle: "Sitios por sector",
    sitesLead: "Seis experiencias completas para profesionales, hospitalidad, salud, comercio y cultura.",
    projectsCount: "15 proyectos en vivo",
    archiveTitle: "Más ejemplos",
    archiveLead: "Los experimentos anteriores siguen disponibles en un archivo separado de los quince proyectos principales.",
  ...
  fr: {
    ...
    sitesTitle: "Sites par secteur",
    sitesLead: "Six expériences complètes pour services professionnels, hôtellerie, santé, commerce et culture.",
    projectsCount: "15 projets en direct",
    archiveTitle: "Plus d’exemples",
    archiveLead: "Les expériences précédentes restent disponibles dans une archive séparée des quinze projets principaux.",
  ...
  de: {
    ...
    sitesTitle: "Websites nach Branche",
    sitesLead: "Sechs vollständige Erlebnisse für Beratung, Gastgewerbe, Gesundheit, Handel und Kultur.",
    projectsCount: "15 Live-Projekte",
    archiveTitle: "Weitere Beispiele",
    archiveLead: "Frühere Experimente bleiben in einem separaten Archiv neben den fünfzehn Hauptprojekten verfügbar.",
  ...
  pt: {
    ...
    sitesTitle: "Sites por setor",
    sitesLead: "Seis experiências completas para profissionais, hotelaria, saúde, comércio e cultura.",
    projectsCount: "15 projetos ao vivo",
    archiveTitle: "Mais exemplos",
    archiveLead: "Experimentos anteriores permanecem em um arquivo separado dos quinze projetos principais.",
